...
# Overtime increases profit by $30,600,000 – $26,640,000 = $3,960,000.
...
# Set right hand side parameters back to the original values
f.par <- c(48000,
           20000,
           3500)
...
# Set Coefficients of Obj Function back to original value
f.obj[1] <- 3600

# Change first value in the Matrix corresponding to constraints coefficients
f.con[1, 1] <- 7.5
