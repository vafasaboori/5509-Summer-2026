...
ub <- c(4, 6)  # Upper bounds (somewhat redundant)

# Set options for termination criterion
opts <- list(
  "algorithm" = "NLOPT_LN_COBYLA", # COBYLA algorithm for nonlinear programming
  "xtol_rel" = 1e-06 # Convergence tolerance: stop when changes in the solution become extremely small
)
